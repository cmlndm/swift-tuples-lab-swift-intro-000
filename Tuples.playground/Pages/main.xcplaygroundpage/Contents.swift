 ...
 */
// write your code here
print("\(someone.name) is \(someone.age) is years old")
 ...
 */
// Answer:
// a) No, I cannot change human's age
// b) Because is a human is a let constant
